export default {
    ...
    confirmFriend: (messageObject) => {
        return `
        <p class="confirmFriend--${messageObject.userId}" id="confirmFriend--${messageObject.id}">Would you like to add <b id="friendName">${messageObject.user.username}</b> as a friend?"</p>
